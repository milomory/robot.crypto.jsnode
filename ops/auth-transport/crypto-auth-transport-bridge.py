#!/usr/bin/python3 -I
"""Fixed model-blind Crypto Auth transport operation; no arbitrary targets or commands."""
import argparse
import grp
import json
import os
...
SOCKET = '/run/agent-secrets-broker/crypto-auth-transport.sock'
SELF = '/usr/local/libexec/crypto-auth-transport-bridge.py'
REMOTE = '/usr/local/libexec/crypto-auth-transport-remote.py'
